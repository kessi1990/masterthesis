...
# sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_darqn.sh Seaquest-v0 1 4 add 128
#sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_darqn.sh Seaquest-v0 1 2 concat 128
# sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_darqn.sh Seaquest-v0 2 4 add 64
...
# sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_darqn.sh BeamRider-v0 1 4 add 128
#sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_darqn.sh BeamRider-v0 1 2 concat 128
# sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_darqn.sh BeamRider-v0 2 4 add 64
...
sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_dqn.sh Breakout-v0 0 7
sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_dqn.sh Seaquest-v0 0 7
sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_dqn.sh BeamRider-v0 0 7
# sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_dqn.sh SpaceInvaders-v0 0 5
# sbatch --partition=Gobi,Luna --gres=gpu:0 --exclusive batch_dqn.sh Pong-v0 0 5
