...
class GUI:
    ...
    def display(self, env):
        ...
        a_col = pygame.transform.scale(a_col, (self.scale, self.scale))
        ...
        g_col = pygame.transform.scale(g_col, (self.scale, self.scale))
        ...
        for obs in env.obs_coords:
            ...
            """
            e_col = pygame.image.load("../gui/rooms/assets/obstacle.png")
            e_col = pygame.transform.scale(e_col, (self.scale, self.scale))
